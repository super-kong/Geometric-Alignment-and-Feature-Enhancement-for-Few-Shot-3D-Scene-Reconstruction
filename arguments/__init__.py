...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.sd_lora_weight = 1.0
        self.sd_lora_lr = 0.0001
        self.lora_start_iter = 2000
        self.sd_guidance_start_iter = 2000
        self.warp_sds_guidance_start_iter = 2000
        self.pixel_guidance_start_iter = 2000
